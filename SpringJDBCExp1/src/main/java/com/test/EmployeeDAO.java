...
public class EmployeeDAO {
	...
	public int createEmployee(Employee emp) {
		String sql = "insert into employee2 (e_name, e_cmp, e_city)" + "values('" + emp.getE_name() + "','" + emp.getE_cmp() + "','" + emp.getE_city() + "')";
		return jdbcTemplate.update(sql);
	}
	
	public int updateEmployee(Employee emp) {
		String sql = "update employee2 set e_name = '" + emp.getE_name() + "', e_cmp = '" + emp.getE_cmp() + "', e_city = '" + emp.getE_city() + "' where id = "+emp.getId();
		return jdbcTemplate.update(sql);
	}
	
	public int deleteEmployee(Employee emp) {
		String sql = "delete from employee2 where id = " + emp.getId();
		return jdbcTemplate.update(sql);
	}
	...
	public void insertEmployee(Employee emp) {
		String sql = "insert into employee2 (e_name, e_cmp, e_city)" + "values(:e_name, :e_cmp, :e_city)";
